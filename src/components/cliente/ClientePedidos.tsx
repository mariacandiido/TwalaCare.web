...
import { Package, MapPin, Clock, CheckCircle, XCircle, Eye } from "lucide-react";
...
const allOrders = [
  ...
  },
  {
    ...
    deliveryEstimate: "Entregue às 10:45",
  },
  {
    id: "#TC12343",
    date: "18 Jan 2026 16:20",
    status: "Entregue",
    ...
    deliveryEstimate: "Entregue às 17:00",
  },
  {
    id: "#TC12342",
    date: "15 Jan 2026 09:00",
    status: "Cancelado",
    farmacia: "Farmácia Bem-Estar",
    items: [
      { name: "Omeprazol 20mg", quantity: 1, price: 2200 },
    ],
    subtotal: 2200,
    delivery: 500,
    total: 2700,
              ...
              <div className="bg-white rounded-xl shadow-md p-6">
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-gray-900">{selectedOrder.farmacia}</p>
                  </div>
                  <div>
                ...
                <div className="border-t pt-4 space-y-2">
                  ...
                  <div className="flex justify-between text-sm text-gray-600">
                    ...
                    <span>{selectedOrder.delivery.toLocaleString()} Kz</span>
                  </div>
